...
<div class="bg-lg-body mx-lg-4 radius-14 py-lg-5 my-lg-n5 position-relative">
    <div class="container-xl pt-3 pt-lg-5">
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-3 px-2 ml-auto">
                        <div class="input-border rounded bg-white h-100 mb-0 d-flex align-items-center">
                            <div class="d-flex align-items-center p-1 ml-2 py-2 w-100">

                                <div class="custom-control custom-radio w-50 text-center pl-0">
                                ...
                                <div class="custom-control custom-radio ml-2 w-50 text-center pl-0">
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3 mb-lg-4">
                <div onclick="mySliderFunction()" class="bg-white radius-8 pointer hover-img">
                    ...
                    <div class="p-3 text-center">
                        <div class="font-weight-bold text-special font-20 mb-2">
                            İSO - Sertifikatı
                        </div>
...
<div id="mySlider" style="display: none"
     class="position-fixed top-0 right-0 align-items-center justify-content-center w-100 h-100 gallery z-index-999999">
    <div class="container-xl">
