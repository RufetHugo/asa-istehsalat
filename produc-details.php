    ...
    <div class="row mb-3">
        <div class="col-12 col-lg-6">
            ...
            <p class="font-17">
                ...
                avadanl1qda, texniki normalara va Avropa standartlanna cavab veran 190 x 390 x 188, 150 x 390 x 188, 90
                x 390 x 188 6I\;0larda divar bloklan istehsal edirik. Divar bloklannin daha bir Ostunluyu isa sarfali
                qiymatidir: divar bloklan karpicin butun funksionalhgin1 avaz etsa da qiymati karpica nisbatan qat-qat
                ucuzdur.
            </p>

            <button class="btn bg-yellow text-white px-5 py-2 mb-2">
    ...
    <div>
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                <div class="radius-8 shadow-main-two">
                    <div class="embed-responsive embed-responsive-16by9">
                        <img src="assets/images/Rectangle 5937.jpg"
                             class="embed-responsive-item object-cover" alt="">
                    </div>
