            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-lg-6 mb-3 px-2">
                    <div class="form-group mb-0">
                        <input type="text" placeholder="Ad, Soyad" class="form-control input-border rounded" id="inputEmail4">
                    </div>
                </div>

                <div class="col-12 col-lg-6 mb-3 px-2">
                    <div class="form-group mb-0">
                        <input type="text" placeholder="Email" class="form-control input-border rounded" id="inputEmail4">
                    </div>
                </div>
                ...
                <div class="col-12 mb-3 px-2">
                    <div class="form-group mb-0">
                        <textarea type="text" placeholder="Mesajınız" class="form-control input-border rounded" id="inputEmail4"></textarea>
                    </div>
                </div>

                <div class="col-12">
                    <div class="d-flex align-items-center">
                        <div class="text-success ml-auto mr-2">
