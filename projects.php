...
<div class="container-xl">
    ...
    <div class="history position-relative">
        ...
        <div class="history-circle bg-main-special p-2 px-5 rounded d-inline-block text-white mb-3 ml-3">
            2019
        </div>
        ...
        <div class="row mb-3 ml-1">
            ...
            <div class="col-12 col-md-7 col-lg-8">
                <div class="py-2">
                    ...
                    <div class="font-weight-bold mb-3 font-16">
                        Premium Residential Complex "Renessans Palace"
                    </div>

                    <div class="text-muted mb-2 font-14">
    ...
    <div class="breadcrumb radius-10 mt-2 py-3 py-lg-5">
        ...
        <div class="container-xl">
            ...
            <div class="border rounded text-white d-inline-block px-3 py-2">
                ...
                <span class="font-17">Layihələr</span>
            </div>
        </div>
